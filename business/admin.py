    ...
    def process_approval(self, request_obj):
        if request_obj.status == 'approved':
            ...
            try:
                ...
                restaurant.qr_code_link = f"https://quickchart.io/qr?text=http%3A%2F%2Flocalhost%3A3000%2Frestaurants%2Frewards%3Fid%3D{restaurant.id}&size=200¢erImageUrl=https%3A%2F%2Fwww.jacareview.com%2F_next%2Fimage%3Furl%3D%252F_next%252Fstatic%252Fmedia%252Flogo-home--.135443cd.png%26w%3D1080%26q%3D75"
                restaurant.save()
