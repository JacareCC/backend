...
from jacare.views import login_user, register_user, query_restaraurant, restaurant_detail, user_history, add_to_user_history, new_review, change_user_saved_restaurants, get_user_saved_restaurants, new_claim_request, verify_review, get_reviews, new_tier_level, get_all_tiers
